    ...
    export const wireTitleWindow = document.getElementById("wire-title-window")
    export const wireWindowFirstInput = document.getElementById("wire-window-first-input")
    export const wireWindowSecondInput = document.getElementById("wire-window-second-input")
    export const wireWindowSaveButton = document.getElementById("wire-window-save-button")
